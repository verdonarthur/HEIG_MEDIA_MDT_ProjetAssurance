...
return [
    ...
    */
    ...
    'integer'              => 'Le champ :attribute doit être un entier (ne commençant pas par un 0).',
    ...
    */
    ...
    'custom'               => [
        ...
        'ligne.*.a_id' => [
            'required' => "L'ID de l'article est obligatoire.",
            'required_with' => "L'ID de l'article est obligatoire quand la quantité est présente."
        ],
        'ligne.*.quantite' => [
            'required' => "La quantité pour l'article est obligatoire.",
            'required_with' => "La quantité est obligatoire quand l'ID de l'article est présent.",
        ]
    ],
    ...
    */
    ...
    'attributes'           => [
        ...
        'size'                  => 'Taille',
        'ligne.1.a_id'          => "ID de l'article 1",
    ],
